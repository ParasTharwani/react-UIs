...
function Header() {
  ...
  return (
    <header className="header">
      <h1 style={style}>Pizza Heaven Co.</h1>
    </header>
  );
}
function Menu() {
  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>
            Authentic italian cuisine with 6 different Pizza flavours. All from
        ...
        <p>We're Currently working on it. please come back later :) </p>
      )}
      {/* <Pizza
        name="Pizza Spinaci"
        ingredients="Tomato, mozarella, spinach, and ricotta cheese"
...
//props : communication channel between a parent and child from parent component to child down the component tree
